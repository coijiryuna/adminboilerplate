...
<?= $this->include('permission/create') ?>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="float-right">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-block btn-primary" id="create-book" data-bs-toggle="modal" data-bs-target="#modal-create-permission"><i class="fa fa-plus"></i>
