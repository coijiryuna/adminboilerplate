<!DOCTYPE html>
<html lang="<?= config('App')->defaultLocale ?>" data-bs-theme="auto">
...
<body class="layout-fixed layout-navbar-fixed sidebar-mini layout-fixed <?= config('Boilerplate')->theme['footer']['fixed'] ? 'layout-footer-fixed' : '' ?> <?= config('Boilerplate')->theme['body-sm'] ? 'text-sm' : '' ?>">
  <div class="wrapper">
    ...
    <footer class="main-footer">
      ...
      <div class="float-right d-none d-sm-inline">
        <strong><a href="https://github.com/coijiryuna" target="_blank">coijiryuna</a></strong>
      </div>
      <!-- Default to the left -->
  ...
  <!-- <script src="https://kit.fontawesome.com/6d3a31e489.js" crossorigin="anonymous"></script> -->
